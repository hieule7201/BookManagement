class BookmanagesController < ApplicationController
  ...
  private
    ...
    def bookmanage_params
      params.require(:bookmanage).permit(:student_id, :fullname, :class_name, :book_id, :book_name, :author_name, :source_name, :bm_number, :first_day, :last_day, :day_number, :note)
    end
end
